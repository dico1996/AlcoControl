        ...
        public class Camera2BasicFragment : Fragment, View.IOnClickListener
        {
            ...
            private void TakePicture()
            {
                try
                {
                    ...
                    // Output file
                    var directory = activity.GetExternalFilesDir(null);
                    var numberFiles = System.IO.Directory.GetFiles(directory.Path).Length;

                    file = new File(directory, numberFiles + ".jpg");
            ...
            public void OnClick(View v)
            {
                switch (v.Id)
                {
                    case Resource.Id.picture:
                        ...
                        this.Activity.SetResult(Result.Ok, intent);
